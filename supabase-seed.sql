...
-- Known RP-C registry values, editable through the admin console
insert into public.rpc_registry (registration, aircraft_type, cas_climb, cas_cruise, gph)
values
  ('832','C152','70','85','6'),
  ('840','C152','70','85','6'),
  ('860','C152','70','85','6'),
...
on conflict (registration) do update set
  ...
  cas_climb = excluded.cas_climb,
  cas_cruise = excluded.cas_cruise,
  gph = excluded.gph;
